...
import 'package:myproject/app/modules/home/models/canil_model.dart';
import 'package:myproject/app/modules/home/repositories/canil_interface.dart';
  ...
  Future<CanilModel> findById(id) async {
    ...
    try {
      ...
      if (maps.first.length > 0) {
        return CanilModel.fromJson(maps.first);
      }
    } catch (error) {
      print(error);
    }
